<div class="col-md-12 col-sm-12 col-xs-12 profile_base_div verfication_trust_inner video_margin">
	<div class="edit_profile_head col-md-12 col-sm-12 col-xs-12">
	   <div class="col-md-7 col-sm-7 col-xs-12 trans_payment_method">
		  <div class="col-md-5 col-sm-5 co-xs-12 payment_method_1">
			 <select class="transaction_on_change_ajax select-control" id="transaction_completed_payment_type">
		  ...
		  <div class="col-md-5 col-sm-5 co-xs-12 payment_method_2">
			 <select id="transaction_completed_listing" class="transaction_on_change_ajax select-control">
		  ...
		  <div class="col-md-2 col-sm-2 co-xs-12 payment_method_3">
			<select class="select-control transaction_on_change_ajax" id="transaction_completed_year">
	   ...
	   <div class="col-md-5 col-sm-5col-xs-12 trans_payment_method">
		  <div class="col-md-6 col-sm-6 co-xs-12 payment_method_4">
			<select class="select-control transaction_on_change_ajax" id="transaction_completed_from" >
		  ...
		  <div class="col-md-6 col-sm-6 co-xs-12 payment_method_5">
			<select class="select-control transaction_on_change_ajax" id="transaction_completed_to" >
	   ...
	   <table class="reservaion_table custom_width_class">
		  <thead class="reservation_details_head">
			 <tr>
				...
				<th class="reserve_list_2"><?php echo get_lang_site_key($lang_key,"home_lang","type"); ?></th>
		  ...
		  <tbody id="transaction_compted_tbody">
			 <?php $not=0; if($completed_transaction->num_rows()>0){ foreach($completed_transaction->result() as $ct){?>
			 <tr>
				<td>
				   <p><?php echo get_lang_site_key($lang_key,"common_lang",strtolower(date('M',strtotime($ct->payment_date)))).date("M d, Y",strtotime($ct->payment_date));?></p>
				</td>
				<td>
