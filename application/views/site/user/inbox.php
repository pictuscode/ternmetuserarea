                    ...
                    <div class="container">
                            <div class="col-md-12 col-sm-12 col-xs-12 inbox_msg_base">
                                            <ul class="nav nav-tabs" role="tablist">
                                                    <li role="presentation"  ><a href="#Traveling" aria-controls="Traveling" onclick="traveler_tabbtn()" role="tab"  data-toggle="tab"><?php echo get_lang_site_key($lang_key,"header_footer_lang","guest"); ?> </a></li>
                                                    <li role="presentation" class="active"><a href="#Hosting" aria-controls="Hosting" role="tab" onclick="host_tabbtn()"  data-toggle="tab"> <?php echo get_lang_site_key($lang_key,"header_footer_lang","host"); ?>  </a></li>
                                            </ul>
                                            <div class="inbox_filter">
                                                    <select class="select-control" id="filter_host1">
													...
													<select class="select-control" id="filter_user1">
                                            ...
                                            <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane" id="Traveling">
