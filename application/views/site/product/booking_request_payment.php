								...
								<div class="col-md-12 col-sm-12 col-xs-12 review_trip_inner">
											...
											<div class="col-md-8 col-sm-6 col-xs-12 review_trip_lft">
												...
												<div class="col-md-8 col-sm-10 col-xs-12 review_trip_lft_inner">
																...
																<select class="select-control" id="payment_type_request_book">
												...
												<div class="col-md-12 col-sm-12 col-xs-12 custom_booking_card_base">
													<?php
													$attributes = array( 'id' => 'stripe_payment_form_request','method'=>'post');
                                                    ...
                                                    <input type="hidden" value="<?php echo $bid;?>" id="booking_id" />
												</form>
												...
												<div class="col-md-10 col-sm-10 col-xs-12 cancel_policy_base nopadd">
														...
														<div class="col-md-12 col-sm-12 col-xs-12 nopadd pay_u_base">
															<p><?php  echo get_lang_site_key($lang_key,"product_lang","redirect_pay");  ?>.<strong> <?php  echo get_lang_site_key($lang_key,"product_lang","complete_process_transcation");  ?>. </strong></p>
														</div>
												...
												<div class="col-md-10 col-sm-10 col-xs-12 agree_continue nopadd">
														<a href="javascript:void(0);" class="button_new" id="paybtn_request_book" ><?php  echo get_lang_site_key($lang_key,"common_lang","pay");  ?></a>
												</div>
										</div>	
										<div class="col-md-4 col-xs-12 col-sm-6 review_trip_rgt">
													<div class="col-md-12 col-sm-12 col-xs-12 review_trip_inner">
