                                                    ...
                                                    <div class="dropdown">
                                                            <button id="properties_dropdown" class="prop_btn"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                              <?php $i=1; foreach($product_details->result() as $pd){ if($i==1){ ?>
															   ...
															   <span class="main_selected_text selected_dropdown_title"><?php if(strlen($pd->listing_title)>18){echo mb_substr($pd->listing_title,0,18).'..'; } else { echo $pd->listing_title;}?></span>
															   </p>
															  <?php $i++;}}?>
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="properties_dropdown" id="prodcut_dropdown">
																	...
																	<li data-id="<?php echo $pd->id;?>" data-title="<?php if(strlen($pd->listing_title)>18){echo mb_substr($pd->listing_title,0,18).'..'; } else { echo $pd->listing_title;}?>" data-img="<?php echo base_url();?>images/site/product/<?php echo $pd->cover_photo==""?"product.png":$pd->cover_photo;?>">
                                                                        <p title="<?php echo $pd->listing_title;?>"><span class="properties_img" style="background:url(<?php echo base_url();?>images/site/product/<?php echo $pd->cover_photo==""?"product.png":$pd->cover_photo;?>)"></span><span class="main_selected_text"><?php if(strlen($pd->listing_title)>18){echo mb_substr($pd->listing_title,0,18).'..'; } else { echo $pd->listing_title;}?></span></p>
                                                                    </li>
																	<?php }?>
                                                            </ul>
                                                          </div>
