					...
					<div class="col-md-12 col-sm-12 col-xs-12  review_pay_head">
						...
						<div class="col-md-10 col-xs-12 col-sm-10 review_trip_title">
								<ul class="list-inline">
										<li><a <?php if($this->uri->segment(3)=="house-rules"){?>class="active" <?php } ?> href="javascript:void(0)">1. <?php  echo get_lang_site_key($lang_key,"header_footer_lang","review_trip_details");  ?></a></li>
										<li><a <?php if($this->uri->segment(3)=="whos-coming"){?>class="active" <?php } ?> href="javascript:void(0)">2. <?php  echo get_lang_site_key($lang_key,"header_footer_lang","whos_coming");  ?>? </a></li>
										<li><a  <?php if($this->uri->segment(3)=="confirm-and-pay"){?>class="active" <?php } ?>href="javascript:void(0)">3. <?php if($product_detail->row()->instant_booking==1){?><?php  echo get_lang_site_key($lang_key,"header_footer_lang","confirm_and_pay");  ?><?php } else{ ?><?php  echo get_lang_site_key($lang_key,"product_lang","request_book_confirmation");  ?> <?php }?></a></li>
								</ul>
						</div>
				</div>
