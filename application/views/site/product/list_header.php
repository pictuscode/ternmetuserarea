...
<header>
		<div class="col-md-12 col-sm-12 col-xs-12 listing_base_head">
			<div class="col-md-12 col-sm-12 col-xs-12 logo">
				<div class="logo_img col-md-1 col-sm-2 col-xs-2 custom_listing_host_img">
					   <a href="<?php echo base_url();?>" class="logo_svg custom_svg_logo" ><img src="<?php echo base_url();?>images/site/logo/<?php echo $this->config->item('site_logo')!=''?$this->config->item('site_logo1'):'logo1.svg';?>"></a>
						<h6>Host</h6>
				</div>
				
				<!-- <div class="save_and_exit_head col-md-2 col-sm-2 col-xs-12 custom_listing_host_save_btn custom_save_mobile">
					<ul class="list-inline">	
						<li><a class="button_new" href="#">Save & Exit</a></li>	
					</ul>
				</div> -->
				
				
				<div class="list_tab_head col-md-9 col-sm-10 col-xs-12 custom_listing_head">
					<!-- Nav tabs -->
						<div class="tab_for_fixed_position custom_listing_tab_fixed">
								<ul class="nav nav-tabs" role="tablist" id="listingtab">
									...
									<li role="presentation" class=""><a href="#publish" onclick="loadpublish_tab();" aria-controls="publish" role="tab" data-toggle="tab"> <?php echo get_lang_site_key($lang_key,"home_lang","publish") ?></a></li>
								</ul>
				...
				<!-- <div class="save_and_exit_head col-md-2 col-sm-2 col-xs-12 custom_listing_host_save_btn custom_save_desktop">
					<ul class="list-inline">	
						<li><a class="button_new" href="#">Save & Exit</a></li>	
					</ul>
				</div>	 -->	
