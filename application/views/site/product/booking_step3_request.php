					...
					<div class="container">
								<div class="col-md-12 col-sm-12 col-xs-12 review_trip_inner">
											...
											<div class="col-md-8 col-sm-8 col-xs-12 review_trip_lft">
												<h2><?php  echo get_lang_site_key($lang_key,"product_lang","request_book_confirmation");  ?></h2>
												...
												<div class="col-md-10 col-sm-10 col-xs-12 agree_continue nopadd">
														<a href="javascript:void(0);" id="request_paybtn" class="button_new" ><?php  echo get_lang_site_key($lang_key,"product_lang","request_a_book");  ?></a>
												</div>
										  </div>
										...
										<div class="col-md-4 col-xs-12 col-sm-4 review_trip_rgt">
													<div class="col-md-12 col-sm-12 col-xs-12 review_trip_inner">
															...
															<div class="col-md-12 col-sm-12 col-xs-12 rate_night_base">
																	...
																	<p>Cleaning fee <span class="pull-right"><?php echo $currency_symbol;?><?php echo round($currency_rate*$cleaning_fee);?> </span>	</p>
																	<?php } ?>
																	<?php if($service_fee!=""){ ?>
