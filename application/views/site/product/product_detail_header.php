...
<body>
	<header> 
	<?php if($logincheck!=""){?>
				<div class="col-md-12 col-sm-12 col-xs-12 search_header_base">
						<div class="logo_toggle">
								<div class="dropdown dropdown_custom">
										...
										<a href="<?php echo base_url();?>"  id="dLabel" data-toggle="dropdown">
												<span class="logo_svg"><img src="<?php echo base_url();?>images/site/logo/<?php echo $this->config->item('site_logo')!=''?$this->config->item('site_logo1'):'logo1.svg';?>"></span>
												<p><?php echo get_lang_site_key($lang_key,"header_footer_lang","host"); ?> <span class="dropdown_icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.7 6.82"><title></title><g id="Layer_2" data-name="Layer 2"><g id="_1" data-name="1"><path d="M11.7,1a.37.37,0,0,1-.12.27L6.12,6.7a.36.36,0,0,1-.54,0L.12,1.24A.36.36,0,0,1,.12.7L.7.12a.36.36,0,0,1,.54,0l4.61,4.6,4.6-4.6a.36.36,0,0,1,.54,0l.59.58A.37.37,0,0,1,11.7,1Z" style="fill:#5f5f5f"/></g></g></svg></span></p>
											</a>
										<ul class="dropdown-menu" aria-labelledby="dLabel">
										 <li><a href="<?php echo base_url();?>" >
											<span class="logo_svg"><img src="<?php echo base_url();?>images/site/logo/<?php echo $this->config->item('site_logo')!=''?$this->config->item('site_logo'):'logo.svg';?>"></span>
											<p><?php echo get_lang_site_key($lang_key,"header_footer_lang","guest"); ?> </p>
										    </a></li>
										</ul>
										<?php } ?>
								</div>
						...
						<div class="search_bar_base  custom_login_search_bar_base <?php if($logincheck==$product_details->user_id){ echo "hidesearchbar"; } ?>">
						...
						<div class="search_tab_base">
										<?php if($logincheck!=$product_details->user_id){?>
										<div class="list_tab_head">
												<!-- Nav tabs --><?php  $valid=$this->uri->segment(1);?>
													<div class="tab_for_fixed_position custom_tab_fixed_postion">
															<ul class="nav nav-tabs" role="tablist">
																<li role="presentation" class="<?php if($valid=="wishlist"){  echo "active";}?>"><a href="<?php echo base_url();?>wishlist<?php ?>"><?php echo get_lang_site_key($lang_key,"header_footer_lang","saved"); ?> </a></li>
										...
										<div class="list_tab_head">
												<!-- Nav tabs --><?php  $valid=$this->uri->segment(1);?>
													<div class="tab_for_fixed_position custom_tab_fixed_postion">
															<ul class="nav nav-tabs custom_tab_nav_fixed" role="tablist">
																<li role="presentation" class=""><a href="<?php echo base_url();?>inbox" ><?php echo get_lang_site_key($lang_key,"header_footer_lang","inbox");?></a></li>
																<li role="presentation" class=""><a href="<?php echo base_url();?>calendar" ><?php echo get_lang_site_key($lang_key,"header_footer_lang","calendar"); ?></a></li>
																<li role="presentation" class=""><a href="<?php echo base_url();?>listings" ><?php echo get_lang_site_key($lang_key,"header_footer_lang","listing");?></a></li>
																<li role="presentation" class=""><a href="<?php echo base_url();?>stats" ><?php echo get_lang_site_key($lang_key,"header_footer_lang","stats"); ?></a></li>
															</ul>
													</div>
				...
				<?php } else {?>
				<div class="col-md-12 col-sm-12 col-xs-12 head_base search_header_base">
					<div class="col-md-12 col-sm-12 col-xs-12 logo">
						<div class="logo_img_base logo_toggle custom_logo_base">
						...
						<div class="search_bar_base custom_search_base">
								<div class="search_bar_inner custom_login_search_bar_inner">
                                        <span class="custom_search_icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.53 19.11"><path d="M14.92,13.82l1.44,1.36L19.3,18a.65.65,0,0,1,.16.8.63.63,0,0,1-1,.16L16.62,17.2l-2.5-2.37-.07-.07-.28.25a8.17,8.17,0,0,1-4.07,1.89,8.36,8.36,0,0,1-9.4-6.17A8.6,8.6,0,0,1,0,7.82,8.41,8.41,0,0,1,6.56.21a8.05,8.05,0,0,1,7.88,2.44A8,8,0,0,1,16.6,7,8.49,8.49,0,0,1,15,13.71ZM8.36,15.74l.81-.06.43-.07a6.85,6.85,0,0,0,4.22-2.49,7.11,7.11,0,0,0,1.4-6.51A7.08,7.08,0,0,0,7.29,1.38,6.8,6.8,0,0,0,2.82,4a7.12,7.12,0,0,0-1.28,6.46A7.13,7.13,0,0,0,8.36,15.74Z" style="fill-rule:evenodd"/></svg></span>
										<input type="text" placeholder="<?php echo get_lang_site_key($lang_key,"header_footer_lang","search_placeholder"); ?>" id="search_autocomplete" value="<?php if(isset($city)) echo $city;?>">
								</div>
