	...
	$.fn.gallerie = function (method) {
		...
		function rebuildOverlay(target, imageLinks){
			var $this = $(target),
				...
				$overlay = $('<div class="gallerie-overlay"/> </div>'),
				$imageBox = $('<div class="gallerie-imagebox"/> '),
				$image = $('<img class="gallerie-image"/>'),
				$imageLoading = $('<div class="gallerie-loading"/>'),
				$captionBox = $('<div class="gallerie-captionbox"><div class="gallerie-text"><div class="gallerie-title"/><div class="gallerie-index"/></div></div> <div class="gallery-nav"> <div class="gallerie-control gallerie-control-previous"><img src="'+baseurl+'images/previous.png"></div> <div class="gallerie-control gallerie-control-next"><img src="'+baseurl+'images/next.png"></div></div> '),
				$thumbList = $('<ul></ul>'),
